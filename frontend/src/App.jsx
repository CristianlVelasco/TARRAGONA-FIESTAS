...
function App() {
  ...
  async function loadAll() {
    ...
    setParties(ps);
    const r = await fetchReport(); // totales globales
    setReport(r);
    setLoading(false);
  }
  ...
  async function handleSubmit(e) {
    e.preventDefault();
    if (!form.cedula || !form.invitados || !form.horas) return alert('Completa todos los campos');
    ...
    <div style={{ maxWidth:900, margin:'2rem auto', fontFamily:'Arial, sans-serif' }}>
      ...
      <section>
        ...
        {report && (
          <div>
            ...
            <p>Total recaudado: {report.totals.totalAmount}</p>
      ...
      <section style={{ marginTop: '1rem' }}>
        ...
        <table border="1" cellPadding="6" style={{ borderCollapse:'collapse', width:'100%' }}>
          <thead>
            <tr><th>Cédula</th><th>Invitados</th><th>Horas</th><th>Monto invitados</th><th>Monto horas</th><th>Total</th></tr>
          </thead>
          <tbody>
            {parties.map(p => (
              <tr key={p._id}>
